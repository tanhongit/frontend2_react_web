                          ...
                          <ul>
                            <li>
                              <a href="product-detail.html">
                                <img src="images/shoe/sidebar/1.jpg" alt />
                              </a>
                            </li>
                            <li>
                              <a href="product-detail.html">
                                <img src="images/shoe/sidebar/2.jpg" alt />
                              </a>
                            </li>
                            <li>
                              <a href="product-detail.html">
                                <img src="images/shoe/sidebar/3.jpg" alt />
                              </a>
                            </li>
                            <li>
                              <a href="product-detail.html">
                      ...
                      <div className="tab-content mb-60">
                        <div className="tab-pane active" role="tabpanel" id="tab_01">
                          <p>
                            ...
                            bear claw liquorice. Gingerbread lollipop dragée cake. Pie
                            topping jelly-o. Fruitcake dragée candy canes tootsie roll.
                            Pastry jelly-o cupcake. Bonbon brownie soufflé muffin.
              </p>
                          <p>
                            ...
                            jujubes topping cake apple pie. Jujubes gummi bears soufflé
                            candy canes topping gummi bears cake soufflé cake. Cotton candy
                            soufflé sugar plum pastry sweet roll..
              </p>
                        </div>
                          ...
                          <div className="ps-review">
                            ...
                            <div className="ps-review__content">
                              ...
                              <p>
                                ...
                                jelly beans powder. Chocolate bar pudding macaroon candy
                                canes chocolate apple pie chocolate cake. Sweet caramels
                                sesame snaps halvah bear claw wafer. Sweet roll soufflé
                                muffin topping muffin brownie. Tart bear claw cake tiramisu
                                chocolate bar gummies dragée lemon drops brownie.
                  </p>
                            </div>
                          </div>
                          <form
